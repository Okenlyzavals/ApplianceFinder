...
/**
 * Utility class that provides functionality to validate if parameters value type is valid.
...
final class ValidParameterTypes {
    ...
    private static final String CONFIG_PATH =
            Objects.requireNonNull(ValidParameterTypes.
     ...
     *
     * @see ValidParameterTypes#VALID_CLASSES
     */
     ...
     * @see ValidParameterTypes#VALID_PARAMETER_TYPES
     */
    static Map<ParamNamesPair, Class<?>> getValidParameterTypes() {
